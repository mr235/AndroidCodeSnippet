...
public class LogUtils {
    ...
    public static void i(String tag, String msg, Throwable tr) {
        if (LEVEL <= INFO) {
            ...
            Log.i(tag, /* getLogInfo(stackTraceElement) +  */msg, tr);
        }
    }
    ...
    public static void v(String tag, String msg, Throwable tr) {
        if (LEVEL <= INFO) {
            ...
            Log.v(tag, /* getLogInfo(stackTraceElement) +  */msg, tr);
        }
    }
    ...
    public static void d(String tag, String msg, Throwable tr) {
        if (LEVEL <= INFO) {
            ...
            Log.d(tag, /* getLogInfo(stackTraceElement) +  */msg, tr);
        }
    }
    ...
    public static void w(String tag, String msg, Throwable tr) {
        if (LEVEL <= INFO) {
            ...
            Log.w(tag, /* getLogInfo(stackTraceElement) +  */msg, tr);
        }
    }
    ...
    public static void e(String tag, String msg, Throwable tr) {
        if (LEVEL <= INFO) {
            ...
            Log.e(tag, /* getLogInfo(stackTraceElement) +  */msg, tr);
        }
    }
